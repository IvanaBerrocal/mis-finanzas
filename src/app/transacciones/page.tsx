...
import { Transaction, TransactionType, TYPE_LABELS, TYPE_COLORS } from "@/lib/types";
          ...
          {filterButtons.map(({ key, label }) => (
            <button
              ...
              className={`px-3 py-1.5 font-medium transition-colors ${
                filter === key ? "bg-emerald-600 text-white" : "text-gray-600 hover:bg-gray-50"
              }`}
            >
              {label}
            </button>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        {visible.length === 0 ? (
          <div className="py-16 text-center text-gray-400">
            ...
            <p className="text-sm mt-1">Agrega tu primera transacción con el botón de arriba</p>
          </div>
        ) : (
